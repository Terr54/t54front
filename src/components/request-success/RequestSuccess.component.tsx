...
const RequestSuccess = ({ success, onClick }: successProps) => {
  ...
  return (
    <ModalWrapper onClick={onClick} showModal={success} showHeader={false} showClose={false} height="auto" width="auto">
      ...
      <Button text='Continue Browsing Markets' bgColor='#E63F07' onClick={() => navigate(path.MARKET)} margin='22px 0px 10px' />
      <Button text='Manage Quotes' bgColor='transparent' border='none' color='#E63F07' />
    </ModalWrapper>
  )
}
