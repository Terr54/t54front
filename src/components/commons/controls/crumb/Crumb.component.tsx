const Crumb = ({ value, onDismiss, background }: { value: string, background?: string; onDismiss: (value: string) => void }) => {
  return (
        <div title={value} style={{ margin: 3, borderRadius: 10, display: 'flex', justifyContent: 'space-around', alignItems: 'center', position: 'relative', background: background ?? '#eee', color: '#303643' }}>
