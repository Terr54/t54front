const translation = {
  ...
  'secure-agro-products-header':
    'Sécuriser des agro-produits de qualité pour les entreprises',
  'we-provide-platform-caption':
    'Nous fournissons à nos clients une plate-forme pour vendre et acheter directement des produits agricoles de qualité issus de sources éthiques',
  'get-started': 'Commencer',
  'terre-name': 'Terre54',
  'who-is-t54': 'Qui est Terre54 ?',
  't54-serves':
    "Terre54 sert les petites et moyennes entreprises qui cherchent à vendre ou à acheter des produits agricoles d'origine africaine. En plus d'offrir un accès inégalé aux produits d'origine africaine, Terre54 offre également aux producteurs africains un nouveau marché.",
  'we-offer': 'Ce que nous offrons',
  'learn-more': 'En savoir plus',
  'ecommerce-platform': 'Plateforme de commerce électronique',
  'ecommerce-platform-text':
    "Profitez de la plate-forme pour vendre ou acheter directement des produits agricoles d'origine éthique à partir de sources vérifiables, gérer les ventes et les achats du début à la fin.",
  'warehousing-storage': "Services d'entreposage et de stockage",
  'warehousing-storage-text':
    'Terre54 propose des entrepôts abordables partout en Europe où vos marchandises peuvent être livrées et temporairement stockées.',
  'source-monitoring': 'Sourcing et surveillance',
  'enagage-source-monitoring':
    "Engagez les services de notre équipe d'approvisionnement et de surveillance pour identifier les produits qui ont été fabriqués de manière éthique ainsi que le respect des normes de qualité.",
  'consulting-services': 'Des services de consultation',
  'need-advice-on-products':
    "Besoin de conseils sur l'image de marque, l'emballage et le stockage des produits ? Notre équipe d'experts est toujours disponible pour vous fournir un aperçu professionnel et vous guider tout au long du processus.",
  'platform-to-serve': 'Une plateforme pour tous vous servir',
  'get-more-access':
    "Obtenez un meilleur accès aux produits agricoles produits de manière éthique ainsi qu'un accès à plus de marché sur le marché de Terre.",
  'market-accessibility': 'Accessible',
  'accessible-marketplace':
    'Le marché Terre est une plate-forme incroyablement conviviale et facile à naviguer; disponible sur tous les appareils et ouvert à tous.',
  'product-quality': 'Produits de qualité',
  'standard-and-healthy-products':
    'Les produits vendus sur le marché sont fabriqués selon des méthodes standard et saines et testés pour leur qualité afin de répondre aux normes de qualité minimales.',
  'system-security': 'Sécurisé',
  'information-security':
    'Toutes vos informations ainsi que vos documents sont entre de bonnes mains. Nos fonctionnalités de paiement sont également très sécurisées et fiables.',
  'support-system': 'Assistance utilisateur 24h/24 et 7j/7',
  'support-and-assistance':
    "Profitez de l'assistance professionnelle 24h/24 et 7j/7 et des conseils de notre équipe d'experts lors de votre premier achat ou vente et des suivants.",
  'terre-basics': 'Bases Terre',
  'trending-products':
    'Les produits les plus recherchés dans des emballages plus petits',
  'terre-blog': 'Terre Blog',
  'blog-articles':
    "Dose hebdomadaire d'articles pour vous tenir au courant de l'actualité de l'agro-industrie.",
  'contact-t54': 'Nous contacter',
  'contact-email': 'E-mail',
  'contact-number': 'Téléphoner',
  'contact-address': 'Adresse',
  'get-in-touch': 'Entrer en contact',
  'hear-from-you': 'Nous aimerions recevoir de vos nouvelles.',
  'your-name': 'Votre nom',
  'email-address': 'Adresse e-mail',
  'service-confirmation': 'Attestation de service',
  'your-message': 'Votre message',
  'submit-info': 'Soumettre',
  'sign-up-to-start':
    "Inscrivez-vous pour commencer à acheter et à vendre des produits à l'international",
  'signup-now': "S'inscrire maintenant",
  'extend-reach': 'Étendez votre portée',
  'extend-reach-text':
    "Terre54 est une plateforme de vente en ligne de produits africains en gros et demi-gros ; de l'Afrique à l'Europe. Le premier du genre. Vous cherchez à faire le plein de produits tropicaux ? Terre54 agit comme intermédiaire entre les acheteurs professionnels en Europe et les vendeurs en Afrique, garantissant qualité, transparence et équité tout au long du processus. Distributeurs, nous vous apportons une solution différente : Un accès facile à des produits africains de qualité et éthiques.",
  ...
  'footer-houses': 'Terre Maisons',
  'footer-logistics': 'Terre Logistique',
  'footer-blog': 'Terre Blog',
  'footer-coming-soon': 'À venir',
  'about-t54': 'À propos de Terre54',
  'about-us-text':
    "À propos de Terre54 Engagé à permettre aux entreprises de s'approvisionner en produits de qualité directement auprès des producteurs africains.",
  'our-mission': 'Notre mission',
  'mission-text':
    "Notre mission est de soutenir les petits exploitants agricoles et leurs syndicats ainsi que les producteurs africains dans leur activité en les accompagnant et en servant d'intermédiaire sur le marché international. Nous nous engageons à privilégier la collaboration avec les producteurs africains afin de leur offrir un meilleur revenu pour leur travail grâce à une communication et une tarification plus transparente que jamais! Nous nous engageons également à encourager nos fournisseurs et nos clients à adopter des politiques et des pratiques commerciales responsables dans notre intérêt mutuel.",
  'our-vision': 'Notre Vision',
  'vision-text': 'Pour rendre le monde plus petit.',
  'terre-values': 'Nos valeurs',
  'terre-values-text':
    "Nous défendons les valeurs de diversité, d'équité et de partenariat dans nos relations avec nos clients et nos fournisseurs.",
  diversity: 'Diversité',
  'diversity-text':
    'Nous offrons une grande variété de produits de différents producteurs et pays.',
  equity: 'Équité',
  'equity-text':
    'Tarification transparente. Signifie des marges accrues pour les Producteurs et Win-Win pour les Producteurs et les Acheteurs.',
  partnership: 'Partenariat',
  'partnership-text':
    'Dans nos relations avec nos Producteurs ou avec nos Clients, la transparence de notre activité est un point clé.',
  'our-team': 'Notre équipe',
  'promo-video-src':
    'https://t54static.s3.eu-west-3.amazonaws.com/image/TERRE+54+VIDEO+PRESENATION_french.mp4',
  'all-articles': 'Tous les articles',
  'international-trade-text': 'Échange international',
  'storage-text': 'Stockage',
  ...
  'join-farmers':
    'Rejoignez plus de 1 000 collègues agriculteurs, fournisseurs et entrepreneurs',
  'get-updates':
    "Recevez une dose hebdomadaire d'articles et de ressources organisés par des experts de Terre54 pour vous aider à prendre les bonnes décisions lors de l'approvisionnement ou de la vente de produits agricoles. Pas de spam. Désabonnez-vous à tout moment.",
  'subscribe-text': "S'abonner",
  'your-email': 'Votre e-mail',
  'market-on-canva-url':
    'https://www.canva.com/design/DAFQ38YfxMI/oc6odg90e6jIvaUngdliTQ/view',
  // terms
  'terms-title': 'Conditions Générales de vente',
  'last-updated': 'Date de dernière mise à jour :',
  'terms-article-1': 'Article 1 - MENTION LEGALES',
  'terms-article-1-p1-1': "Le présent site, accessible à l'URL: ",
  'terms-article-1-p1-2':
    ', est édité par Terre54, SAS Société aux Actions Simplifiées au capital de 5000 euros, inscrite au R.C.S. de Clermont-Ferrand sous le numéro 892 976 176 dont le siège social est situé au 17 rue Lamartine représenté par Ronterrence UDOM dûment habilité.(Ci-après désigné le « Vendeur »). Le numéro individuel TVA de Prestataire : FR00892976176',
  'terms-article-1-p2-1':
    'Le Site est hébergé par la société Amazon Web Services, situé Paris 52 Rue du Port 92000 Nanterre, France. Le Service Client du Vendeur peut être contacté : au numéro suivant ',
  'terms-article-1-p2-2':
    ' aux horaires suivants lundi à vendredi 8h30 à 18h et samedi 9h à 12h. par courriel en vous adressant à ',
  'terms-article-2': "Article 2 - CHAMP D'APPLICATION",
  'terms-article-2-p1':
    "Les présentes conditions générales de vente (les « Conditions Générales ») s'appliquent exclusivement à la vente des produits commercialisés par le Vendeur sur le Site (les « Produits ») à tout client professionnel agissant dans le cadre de son activité et ayant créé un compte (le « Client »). Les Conditions Générales prévoient notamment les conditions d'achat, de paiement et de livraison des Produits commandés par le Client. Le Client peut se reporter à la description de chaque Produit figurant sur le Site afin de connaître les caractéristiques de ce dernier. La passation d'une commande de Produits sur le Site emporte, de la part du Client, l'acceptation préalable sans restriction ni réserve des Conditions Générales, dont le Client déclare avoir pris connaissance.",
  'terms-article-2-p2':
    "Les Conditions Générales sont mises à la disposition des Clients sur le Site où elles sont directement consultables et peuvent également lui être communiquées sur simple demande par tout moyen. Les Conditions Générales sont applicables nonobstant toute stipulation contraire figurant dans tous documents émanant du Client, et notamment dans ses conditions générales d'achat. Les Conditions Générales sont applicables sous réserve de toute stipulation contraire figurant au bon de commande ou à des conditions particulières le cas échéant conclues entre le Vendeur et le Client concerné.",
  'terms-article-2.1': 'Article 2 - PRODUITS ET DISPONIBILITÉ',
  // privacy
  'policy-title': 'Politique de Confidentialité ',
  'of-site': 'DU SITE',
  'policy-article-1': 'Article 1 - PRÉAMBULE',
  'policy-article-1-p1':
    "Cette politique de confidentialité s'applique au site : Terre54.",
  'policy-article-1-p2':
  ...
  'policy-article-1-l4': 'A qui ces données sont transmises;',
  'policy-article-1-l5':
  ...
  'policy-article-2':
    'Aticle - 2: PRINCIPES GÉNÉRAUX EN MATIÈRE DE COLLECTE ET DE TRAITEMENT DE DONNÉES',
  'policy-article-2-p1':
  ...
  'policy-article-2-l6': "L'utilisateur a expressément consenti au traitement;",
  'policy-article-2-l7':
    "Le traitement est nécessaire à la bonne exécution d'un contrat;",
  'policy-article-2-l8': 'Le traitement répond à une obligation légale;',
  'policy-article-2-l9':
  ...
  'policy-article-3-h1': 'DONNÉES COLLECTÉES ET TRAITÉES ET MODE DE COLLECTE',
  'policy-article-3-h1-p1':
    'Les données à caractère personnel collectées sur le site terre54 sont les suivantes: ',
  ...
  'policy-article-3-h1-p7': 'Consenment de utilisateur',
  'policy-article-3-h2': 'TRANSMISSION DES DONNÉES A DES TIERS',
  'policy-article-3-h2-p1':
    'Les données peuvent être transmises au(x) tiers ci-après énuméré(s): ',
  'policy-article-3-h2-p2':
    "certains données collectées sont susceptibles d'etre transférées à paypl, stripe , easyposte, lorsque l'utilisateur réalise le paiement par le baiais de la plateforme de paiement du site",
  'policy-article-3-h3': 'HÉBERGEMENT DES DONNÉES',
  'policy-article-3-h3-p1':
    "Le site terre54 est hébergé par: Amazon, dont le data center est situé à l'adresse en Europe.",
  ...
  'policy-article-4-h1': 'LE RESPONSABLE DU TRAITEMENT DES DONNÉES',
  'policy-article-4-h1-p1':
    'Le responsable du traitement des données à caractère personnel est: Chuka Udom Il peut être contacté de la manière suivante: ',
  ...
  'policy-article-4-h2': 'OBLIGATIONS DU RESPONSABLE DU TRAITEMENT DES DONNÉES',
  ...
  'policy-article-4-h3': 'LE DÉLÉGUÉ À LA PROTECTION DES DONNÉES',
  'policy-article-4-h3-p1':
    "Par ailleurs, l'utilisateur est informé qu'un Délégué à la Protection des Données a été nommé: ronterrence udom.",
  ...
  'policy-article-5': "ARTICLE 5 - DROITS DE L'UTILISATEUR",
  'policy-article-5-l1':
  ...
  'policy-article-5-h1-s1-p2':
    "L'utilisateur doit envoyer un e-mail au responsable du traitement des données personnelles, en précisant l'objet de sa demande à",
  ...
  'policy-article-5-h1-s1-p4':
    "L'utilisateur doit envoyer un e-mail au responsable du traitement des données personnelles, en précisant l'objet de sa demande à",
  'policy-article-5-h1-s2': 'Droit à la portabilité des données',
  ...
  'policy-article-5-h1-s6': "Droit de saisir l'autorité de contrôle compétente",
  ...
  'policy-article-5-h1-s6-p1-c': 'ou tout juge compétent.',
  'policy-article-5-h2': 'DONNÉES PERSONNELLES DES PERSONNES MINEURES',
  ...
  'policy-article-6': 'ARTICLE 6 - UTILISATION DES FICHIERS "COOKIES"',
  'policy-article-6-l1':
  ...
  'policy-article-6-safari':
    'Apple Legal - Engagement de confidentialité d’Apple - Apple  ',
  'policy-article-6-explorer':
    'Supprimer et gérer les cookies - Support Microsoft  ',
  ...
  'policy-article-6-s2-p2':
    'cookie: contact.sas finalité: analyse des habitudes de navigation, sauvegarde des préférences',
  ...
  'policy-article-7-p2': 'rubrique politique confidentialité',
  'policy-article-7-p3':
  ...
  'policy-article-7-p6': "Par email à l'adress communiquée à l'inscription",
  'policy-article-7-p7':
    "Il est porté à la connaissance de l'utilisateur que la dernière mise à jour de la présente politique de confidentialité est intervenue le: 03/04/2021.",
  'policy-article-8':
  ...
  'browse-catalog-text':
    "Parcourez le catalogue pour commencer à acheter et à vendre des produits l'international",
  'farming-contract': 'Contrat Agricole',
  'farming-contract-text':
    "Gérons la plantation selon vos spécifications, contactez-nous pour plus d'informations.",
  'custom-packaging': 'Emballage personnalisé',
  'custom-packaging-text':
    "Sélectionnez vos tailles d'emballage idéales. Nous sommes en mesure de travailler avec des entreprises d'emballage pour vous fournir cela.",
  'quality-assurance': 'Assurance qualité',
  'quality-assurance-text':
    "Puisque nous travaillons directement avec les producteurs, nous avons une visibilité sur l'emplacement des cultures et, plus important encore, nous sommes en mesure de guider les producteurs sur l'importance des certifications, de l'assurance qualité et des tests. En collaboration avec des sociétés de test internationales, nous fournissons les certificats de qualité nécessaires et plus encore.",
  'integrated-logistics': 'Logistique Intégrée',
  'integrated-logistics-text':
    "Vous souhaitez être livré chez vous ou dans l'entrepôt de notre partenaire en Europe ? ou préférez-vous au port de destination ou au port d'origine ? Par fret aérien ou maritime  Contactez-nous pour plus d'informations.",
  'guarantees-verification': 'Garanties et vérification',
  'guarantees-verification-text':
    "Les producteurs sont vérifiés et leurs représentants mais aussi les acheteurs, vendeurs et acheteurs ont l'esprit tranquille.",
  'order-management': 'La gestion des commandes',
  'order-management-text':
    'Des pré-commandes ? à vos conditions, ou bénéficiez de produits déjà disponibles dans notre entrepôt partenaire en France.',
  buyers: 'Acheteurs',
  suppliers: 'Fournisseurs',
  'sign-in-t54': 'Se connecter à Terre54',
  ...
  'sign-up': "S'inscrire",
  'invite-supplier': 'Inviter un fournisseur',
  'supplier-email': 'E-mail du fournisseur',
  'invitation-note': "Note d'invitation",
  'write-supplier-note': 'Ecrire une petite note au fournisseur',
  'copy-link': 'Copier le lien',
  'send-invitation': "Envoyer l'invitation",
  'supplier-invitation-sent': 'Invitations fournisseurs envoyées avec succès',
  'supplier-invitation-failed': "Échec de l'envoi de l'invitation fournisseur",
  'add-new-product': 'Ajouter un nouveau produit',
  'add-product': 'Ajouter un produit',
  'get-started-t54': 'Commencer avec Terre54',
  'signup-buyer': "Inscrivez-vous en tant qu'acheteur",
  'signup-seller': 'Inscrivez-vous en tant que vendeur',
  'first-name': 'Prénom',
  'last-name': 'Nom de famille',
  'already-have-account': 'Vous avez déjà un compte?',
  adress: 'Adresse',
  'type-to-select-address': "Commencez à taper pour sélectionner l'adresse",
  ...
  'happening -text': "Voici ce qui s'est passé avec votre magasin récemment.",
  last: 'Dernière',
  days: 'jours',
  orders: 'Ordres',
  invoices: 'Factures',
  ...
  'back-to-marketplace': 'Revenir à la place de marché',
  ...
  discard: 'Jeter',
  'upload-product-image': "Télécharger l'image du produit",
  product: 'produit',
  edit: 'modifier',
  ...
  'drag-&-drop': 'Faites glisser et déposez ou',
  'click-to-upload': 'Cliquez pour télécharger',
  uploading: 'Téléchargement',
  cancel: 'Annuler',
  stock: 'Action',
  quantity: 'Quantité',
  'unit-measure': 'Unité de mesure',
  'unit-price': 'Prix unitaire',
  currency: 'Monnaie',
  'published-at': 'Publié à',
  'under-review': "À l'étude",
  publish: 'Publier',
  'product-details-saved': 'Détails du produit enregistrés',
  'stock-added-successfully': 'Stock ajouté avec succès',
  add: 'Ajouter',
  'ginger-heading':
    "Découvrez notre gamme d'herbes, d'épices et de plantes aromatiques cultivées dans les conditions les plus favorables. Ceux-ci incluent, le gingembre, le curcuma. basilic, ail, hibiscus et autres sortes d'herbes et d'épices. Environ 60 % des produits ici proviennent du Nigeria ; proéminents pour leur arôme puissant tandis que les 40% restants proviennent d'Afrique du Nord.",
  'all-heading':
    "Découvrez notre gamme d'herbes, d'épices et de plantes aromatiques cultivées dans les conditions les plus favorables. Ceux-ci incluent, le gingembre, le curcuma. basilic, ail, hibiscus et autres sortes d'herbes et d'épices. Environ 60 % des produits ici proviennent du Nigeria ; proéminents pour leur arôme puissant tandis que les 40% restants proviennent d'Afrique du Nord.",
  'garlic-heading':
    "Découvrez notre gamme d'herbes, d'épices et de plantes aromatiques cultivées dans les conditions les plus favorables. Ceux-ci incluent, le gingembre, le curcuma. basilic, ail, hibiscus et autres sortes d'herbes et d'épices. Environ 60 % des produits ici proviennent du Nigeria ; proéminents pour leur arôme puissant tandis que les 40% restants proviennent d'Afrique du Nord.",
  ...
  'latest-to-old': 'Du plus récent au plus ancien',
  'back-to-top': 'Retour au sommet',
  ginger: 'Gingembre',
  garlic: 'Ail',
  pepper: 'Poivre',
  banana: 'Banane',
  'ginger-farmers-model': 'Modèle des agriculteurs de gingembre',
